export const recipes = [
  {
    ...
    photo_url: require('../../assets/images/smoothie_thoughtWorks.png'),
    photosArray: [
      require('../../assets/images/smoothie_thoughtWorks.png'),
      require('../../assets/images/Oats_thoughtWorks.png'),
      require('../../assets/images/waffle_thoughtWorks.png'),
      require('../../assets/images/toast_thoughtWorks.png'),
    ],
    time: '15',
  },
  {
    title: 'Fruity Oatmeal',
    photo_url: require('../../assets/images/Oats_thoughtWorks.png'),
    photosArray: [
      require('../../assets/images/Oats_thoughtWorks.png'),
      require('../../assets/images/smoothie_thoughtWorks.png'),
      require('../../assets/images/waffle_thoughtWorks.png'),
  ...
  },
  {
    ...
    photo_url: require('../../assets/images/waffle_thoughtWorks.png'),
    photosArray: [
      require('../../assets/images/waffle_thoughtWorks.png'),
      require('../../assets/images/smoothie_thoughtWorks.png'),
      require('../../assets/images/Oats_thoughtWorks.png'),
  ...
  },
  {
    ...
    categoryId: 3,
    title: 'French Toast',
    photo_url: require('../../assets/images/toast_thoughtWorks.png'),
    photosArray: [
      require('../../assets/images/toast_thoughtWorks.png'),
      require('../../assets/images/smoothie_thoughtWorks.png'),
      require('../../assets/images/Oats_thoughtWorks.png'),
...
export const types = [
  {
    ...
    photo_url: require('../../assets/images/Breakfast_thoughtWorks.png'),  },
  {
    title: 'Vegetarian',
    subTitle: 'POWER VEGETABLES',
    photo_url: require('../../assets/images/Veggie_thoughtWorks.png'),  },
  {
    title: 'Lunch',
    subTitle: 'HAVE A HEALTHY MEAL',
    photo_url: require('../../assets/images/lunch_thoughtWorks.png'),  },,
  {
    title: 'Dinner',
    subTitle: 'END YOUR DAY WITH AWESOME TASTE',
    photo_url: require('../../assets/images/Breakfast_thoughtWorks.png'), 
   },
];


export const receipeDescription = [
